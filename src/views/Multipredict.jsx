...
const Multipredict = () => {
    ...
    const Res =["Tomato Target Spot","Tomato Mosaic Virus","Tomato Yellow Leaf curl Virus","Tomato Bacterial Spot",
"Tomato Early Blight","Tomato Late Blight","Tomato Leaf Mold","Tomato septoria Leaf Spot","Tomato Spider Mite"];
