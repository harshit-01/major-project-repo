  ...
  return (
    ...
    <div className="headerUpper">
      <div className="headerLogo">
        <Link to="/">
          <img className="headerImage" src={dstLogo} alt=""/></Link>
      </div>
      <div className="headerLogo">
        <Link to="/">
    ...
    <Navbar expand="lg" style={{backgroundColor:"#079450",padding:"10px"}}>
      <Container fluid>
        ...
        <Navbar.Collapse>
          <Nav className="me-auto">
            ...
            <LinkContainer to="/projectTeam">
              <Nav.Link className="navLink" href="">Project Team</Nav.Link>
            </LinkContainer>
            <LinkContainer to="/predict">
              <Nav.Link className="navLink" href="">Predict Disease</Nav.Link>
            </LinkContainer>
            <Link to="/contact">
              <Button className="navBtn" variant="light">Contact Us</Button>
            </Link>
          </Nav>
        </Navbar.Collapse>
