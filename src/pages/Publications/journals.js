        ...
        <>
            ...
            <section>
                ...
                <ul>
                    ...
                    <a href="https://doi.org/10.1007/s13042-022-01562-2">URL:</a>
                    </li>
                    <li className={styles.contentContainer}>
                    Shradha Verma, Anuradha Chug, Amit Prakash Singh, Ravinder Pal
                    ...
                    <a href="https://doi.org/10.48129/kjs.v49i1.10586">URL:</a>
                    </li>
                    <li className={styles.contentContainer}>
                    Anshul Bhatia, Anuradha Chug, Amit Prakash Singh, Dinesh Singh
                    ...
                    <li className={styles.contentContainer}>
                    Nikita Sareen, Anuradha Chug, Amit Prakash Singh (2022). An Image
                    ...
                    <a
                        href="https://www.inderscience.com/info/inarticle.php?artid=116087"
                        >URL:</a
                    >
                    </li>
                    <li className={styles.contentContainer}>
                    Anshul Bhatia, Anuradha Chug & Amit Prakash Singh (2021).
                    ...
                    Indexed).
                    <a
                        href="http://modern-journals.com/index.php/ijma/article/view/670"
                        >URL:</a
                    >
                    </li>
                    <li className={styles.contentContainer}>
                    Nikita Sareen, Anuradha Chug, Amit Prakash Singh, An Image-Based
                    ...
                    <li className={styles.contentContainer}>
                    Anshul Bhatia, Anuradha Chug & Amit Prakash Singh (2020). Plant
                    ...
                    <a href="http://article.nadiapub.com/IJFGCN/vol13_no4/7.html"
                        >URL:</a
                    >
                    <a href="https://bit.ly/36SCVZ9">URL:</a>
                    </li>
                    <li className={styles.contentContainer}>
                    ...
                    <a
                        href="https://www.tandfonline.com/doi/abs/10.1080/09720529.2020.1721890"
                        >URL:</a
                    >
                    </li>
                    <li className={styles.contentContainer}>
                    ...
                    <a
                        href="https://www.tandfonline.com/doi/abs/10.1080/09720510.2020.1724628"
                        >URL:</a
                    >
                    </li>
                    <li className={styles.contentContainer}>
                    Anshul Bhatia, Anuradha Chug & Amit Prakash Singh (2020).
                    ...
                    July 2020).
                    <a
                        href="https://www.tandfonline.com/doi/abs/10.1080/09720510.2020.1799504"
                        >URL:</a
                    >
                    </li>
                    <li className={styles.contentContainer}>
                    ...
                    October 2020).
                    <a href="http://ijcsns.org/07_book/html/202010/202010026.html"
                        >URL:</a
                    >
                    </li>
                </ul>
